...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'goals':
        await query.edit_message_text(
            "🎯 ТВОИ ЦЕЛИ\n\n"
            "1. iPhone 15 - 1000 BYN\n"
            "2. Ideal body\n"
            "3. Экзамены (English, Russian, Society)\n"
            "4. Одежда - 1000 BYN\n"
            "5. Первые деньги ($100-500)\n"
            "6. Master AI\n"
            "7. Дисциплина\n\n"
            "Срок: 3.5 месяца\n"
        ...
        import random
        motivations = [
            "🔥 Ты не бросаешь. Это делает тебя лучше 90%.",
            "💪 Каждый день кода = шаг к $10k/мес.",
            "⚡ Тяжело? Хорошо. Легко было бы — все бы так делали.",
            "🚀 Через 3 месяца ты будешь благодарить себя.",
            "🎯 Маленькие шаги каждый день = большой результат.",
